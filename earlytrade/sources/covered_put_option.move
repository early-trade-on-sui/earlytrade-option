module earlytrade::covered_put_option {
    ...
    use sui::event;
    use sui::clock::Clock;
    use earlytrade::earlytrade::Market;
    ...
    // exericese option
    public(package) fun exercise_option<TradingCoinType>(option: CoveredPutOption<TradingCoinType>, market: &mut Market<TradingCoinType>) {
    ...
    public(package) fun emit_option_created<TradingCoinType>(
        ...
        event::emit(OptionCreatedEvent {
            ...
            collateral_amount: option.collateral_amount,
